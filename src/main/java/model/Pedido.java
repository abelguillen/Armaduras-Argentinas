...
public class Pedido { //ACA FALTA PONER PLANO, SECTOR Y SUBSECTOR PERO SI NO JODE EN NADA, LO DEJO ASI
	...
	public Pedido(long id, String entrega, String codigo, String cliente, String obra, String descripcion, String tipo,
			String totalKg, String cuatrocomados, String seis, String ocho, String diez, String doce, String dieciseis,
			String veinte, String veinticinco, String treintaydos, String otros, String estado, String oc, String pedido,
			String elementos) {
		this.id = id;
		this.entrega = entrega;
		this.codigo = codigo;
	...
	public String toString() {
		return "Pedido [id=" + id + ", entrega=" + entrega + ", codigo=" + codigo + ", cliente=" + cliente + ", obra="
				+ obra + ", descripcion=" + descripcion + ", tipo=" + tipo + ", totalKg=" + totalKg + ", cuatrocomados="
				+ cuatrocomados + ", seis=" + seis + ", ocho=" + ocho + ", diez=" + diez + ", doce=" + doce
				+ ", dieciseis=" + dieciseis + ", veinte=" + veinte + ", veinticinco=" + veinticinco + ", treintaydos="
				+ treintaydos + ", otros=" + otros + ", estado=" + estado + ", oc=" + oc + ", pedido=" + pedido
				+ ", elementos=" + elementos + "]";
	}
